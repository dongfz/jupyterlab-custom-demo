...
export class StaticNotebook extends WindowedList {
        ...
        if (this.notebookConfig.windowingMode === 'defer' && !this.isDisposed) {
            if (!this._idleCallBack) {
                this._idleCallBack = requestIdleCallback((deadline) => {
                    ...
                    void this._updateForDeferMode(deadline.didTimeout
    ...
    async _updateForDeferMode(remainingTime = MAXIMUM_TIME_REMAINING) {
...
export class Notebook extends StaticNotebook {
    ...
    _ensureFocus(force = false) {
        ...
        if (this.mode === 'edit' && activeCell) {
            if (((_a = activeCell.editor) === null || _a === void 0 ? void 0 : _a.hasFocus()) === false) {
