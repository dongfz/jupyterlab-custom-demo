...
function SearchInput(props) {
    ...
    return (React.createElement("textarea", { placeholder: props.placeholder, className: INPUT_CLASS, rows: rows, onChange: e => {
            ...
            props.onKeyDown(e);
            setRows(e.target.value.split(/\n/).length);
        }, tabIndex: 0, ref: props.inputRef, title: props.title, defaultValue: props.value, autoFocus: props.autoFocus }));
}
function SearchEntry(props) {
    ...
    return (React.createElement("div", { className: wrapperClass },
        React.createElement(SearchInput, { placeholder: trans.__('Find'), value: props.searchText, onChange: e => props.onChange(e), onKeyDown: e => props.onKeydown(e), inputRef: props.inputRef, title: trans.__('Find'), autoFocus: true }),
...
function ReplaceEntry(props) {
    ...
    return (React.createElement("div", { className: REPLACE_WRAPPER_CLASS },
        React.createElement("div", { className: INPUT_WRAPPER_CLASS },
            React.createElement(SearchInput, { placeholder: trans.__('Replace'), value: (_b = props.replaceText) !== null && _b !== void 0 ? _b : '', onKeyDown: e => props.onReplaceKeydown(e), onChange: e => props.onChange(e), title: trans.__('Replace'), autoFocus: false }),
